    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9357), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9351), "Spændende!", "Helle K", 4 },
                    { 11, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9555), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9549), "Børnene og jeg nyder at male små sten som vi sætter rundt i byen. Det trækker lidt på smilebåndet.", "Inge K", 7 },
                    { 7, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9396), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9390), "Fine billeder maler også selv med vandfarver og får nogle virkelig unikke billeder.", "Grethe G", 4 },
                    { 10, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9516), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9510), "Det ser sjov ud det skal jeg helt bestemt prøve. Kan jeg bruge hvilken som helst maling til det?", "Johanna L", 5 },
                    { 12, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9595), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9588), "En rigtig god lille DIY gave til alle, og desuden også flot bordpynt eller bordkort til konfirmationer.", "Karen S", 7 },
                    { 13, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9635), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9629), "Hyggelig tidsfordriv. Min mand tværtimod synes vi har nok dekoretet sten i huset :-D", "Lene G", 7 },
                    { 14, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9675), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9669), "Jeg elsker at bruge tid på at finde sten og male på dem.", "Trine D", 7 },
                    { 5, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9314), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9308), "Flotte billeder, som jeg vil elske at have hængende derhjemme.", "Ulla H", 3 },
                    { 4, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9275), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9269), "Malene Rye er en af mine yndlings kunstner, elsker hendes billeder!", "Lilje P", 3 },
                    { 3, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9236), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9229), "Er glade for mine design twin marker.", "Anna M", 2 },
                    { 2, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9148), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9105), "Copic tuscher er dyre men helt klart den bedste på marked!", "Anja K", 2 },
                    { 1, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(7545), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(6918), "Jeg har været glade for Touch Twin marker og bruger dem i mange projekter, dog ønsker jeg Copic tusser da de ser gode ud. ", "Helle H", 2 },
                    { 9, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9474), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9468), "Det griser lidt på bordet men jeg får nogle flotte billeder", " Sanne S", 5 },
                    { 8, new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9436), new DateTime(2020, 5, 21, 15, 44, 6, 269, DateTimeKind.Local).AddTicks(9429), "Det er virkelig sjovt at lave de billeder, og alle roser mine billeder.", "Dorthe F", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7067), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7073), "Er glad for min sæt dog synes jeg det er lige til den dyre side.", "Ann L", 7 },
                    { 5, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7020), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7027), "Fin produkt.", "Lars Kjeld", 7 },
                    { 4, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6977), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6984), "Jeg bruger sættet til alle min kunstnværker og er glad for de forskellige nuancer der findes. Det eneste problem er at de brugt hurtigt ;-)", "Gitte Ly", 7 },
                    { 3, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6933), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6940), "Virkelig lækre farver og afgiver farverne flot på papiret. Bred udvalg af farver.", "Cille P", 7 },
                    { 9, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7190), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7196), "Kvalitets tucher der er gode til mange ting.", "Helena M", 22 },
                    { 10, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7233), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7239), " Gode tuscher jeg bruger dem til kreative ting med mine børnebørn", "Jytte E", 22 },
                    { 8, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7149), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7155), "Jeg elsker elsker disse tucher og jeg sparer op til flere af dem", "Amailie G", 22 },
                    { 2, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6794), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(6860), "God viskelæder.", "Marie L M", 1 },
                    { 1, new DateTime(2020, 5, 21, 15, 44, 6, 264, DateTimeKind.Local).AddTicks(3977), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(4954), "Jeg har altid i den i mine tegneredskaber, den er uundværlig i min hverdag, kan klart anbefales. ", "Karen J", 1 },
                    { 7, new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7108), new DateTime(2020, 5, 21, 15, 44, 6, 268, DateTimeKind.Local).AddTicks(7114), "Gode til at tegne nogle linjer skarp op, kan anbefales.", "Frederikke J", 10 }
                });
