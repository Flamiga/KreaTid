    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2074), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2070), "Spændende!", "Helle K", 4 },
                    { 11, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2197), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2194), "Børnene og jeg nyder at male små sten som vi sætter rundt i byen. Det trækker lidt på smilebåndet.", "Inge K", 7 },
                    { 7, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2098), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2094), "Fine billeder maler også selv med vandfarver og får nogle virkelig unikke billeder.", "Grethe G", 4 },
                    { 10, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2172), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2169), "Det ser sjov ud det skal jeg helt bestemt prøve. Kan jeg bruge hvilken som helst maling til det?", "Johanna L", 5 },
                    { 12, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2221), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2218), "En rigtig god lille DIY gave til alle, og desuden også flot bordpynt eller bordkort til konfirmationer.", "Karen S", 7 },
                    { 13, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2245), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2242), "Hyggelig tidsfordriv. Min mand tværtimod synes vi har nok dekoretet sten i huset :-D", "Lene G", 7 },
                    { 14, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2269), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2266), "Jeg elsker at bruge tid på at finde sten og male på dem.", "Trine D", 7 },
                    { 5, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2047), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2043), "Flotte billeder, som jeg vil elske at have hængende derhjemme.", "Ulla H", 3 },
                    { 4, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2023), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2019), "Malene Rye er en af mine yndlings kunstner, elsker hendes billeder!", "Lilje P", 3 },
                    { 3, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(1997), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(1994), "Er glade for mine design twin marker.", "Anna M", 2 },
                    { 2, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(1950), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(1929), "Copic tuscher er dyre men helt klart den bedste på marked!", "Anja K", 2 },
                    { 1, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(887), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(434), "Jeg har været glade for Touch Twin marker og bruger dem i mange projekter, dog ønsker jeg Copic tusser da de ser gode ud. ", "Helle H", 2 },
                    { 9, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2146), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2143), "Det griser lidt på bordet men jeg får nogle flotte billeder", " Sanne S", 5 },
                    { 8, new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2122), new DateTime(2020, 5, 26, 15, 59, 51, 597, DateTimeKind.Local).AddTicks(2118), "Det er virkelig sjovt at lave de billeder, og alle roser mine billeder.", "Dorthe F", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, 3, "Break Away Heart by Marlene Rye", "../img/BlogBilleder/Marlene-Rye_Break-Away-Heart.jpg", "Coverbillede" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2088), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2092), "Er glad for min sæt dog synes jeg det er lige til den dyre side.", "Ann L", 7 },
                    { 5, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2059), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2063), "Fin produkt.", "Lars Kjeld", 7 },
                    { 4, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2033), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2037), "Jeg bruger sættet til alle min kunstnværker og er glad for de forskellige nuancer der findes. Det eneste problem er at de brugt hurtigt ;-)", "Gitte Ly", 7 },
                    { 3, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2005), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2010), "Virkelig lækre farver og afgiver farverne flot på papiret. Bred udvalg af farver.", "Cille P", 7 },
                    { 9, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2163), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2167), "Kvalitets tucher der er gode til mange ting.", "Helena M", 22 },
                    { 10, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2189), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2193), " Gode tuscher jeg bruger dem til kreative ting med mine børnebørn", "Jytte E", 22 },
                    { 8, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2138), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2142), "Jeg elsker elsker disse tucher og jeg sparer op til flere af dem", "Amailie G", 22 },
                    { 2, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(1907), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(1958), "God viskelæder.", "Marie L M", 1 },
                    { 1, new DateTime(2020, 5, 26, 15, 59, 51, 592, DateTimeKind.Local).AddTicks(9215), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(433), "Jeg har altid i den i mine tegneredskaber, den er uundværlig i min hverdag, kan klart anbefales. ", "Karen J", 1 },
                    { 7, new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2113), new DateTime(2020, 5, 26, 15, 59, 51, 596, DateTimeKind.Local).AddTicks(2116), "Gode til at tegne nogle linjer skarp op, kan anbefales.", "Frederikke J", 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 0, 2, "steadtler-mars-plastic", "../img/varer/steadtler-mars-plastic.PNG", "productImg" },
                    ...
                    { 1, 0, 1, "GRENEviskelæder", "../img/varer/GRENEviskelæder.PNG", "productImg" },
                    ...
                    { 11, 0, 7, "Soft pastel", "../img/varer/Rembrandt-Soft-Pastel-Half-Stick-10-Set_250x.jpg", "productImg" },
                    ...
                    { 12, 0, 8, "soft pastel blyanter", "../img/varer/Bruynzeel-design-pastel-pencil.jpg", "productImg" },
